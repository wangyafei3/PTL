...
public class GetDataXml {
    ...
    public List<Map<String, ?>> getDataXml(String cookie , String u) throws MalformedURLException, ParserConfigurationException, IOException, SAXException, JDOMException{
